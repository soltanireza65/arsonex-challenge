import { ExchangeConvertFacade } from './facades/exchange-convert.facade';
import { ExchangeRateFacade } from './facades/exchange-rate.facade';
import {
  ProviderAProvider,
  ProviderBProvider,
  ProviderCProvider,
...
const ExchangeRateFacades: any[] = [
  ExchangeRateFacade,
  ExchangeConvertFacade,
];
