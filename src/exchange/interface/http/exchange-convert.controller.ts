import { ExchangeConvertFacade } from '@/exchange/application/facades/exchange-convert.facade';
...
export class ExchangeConvertionController {
  constructor(private readonly facade: ExchangeConvertFacade) {}
  ...
  async convertIRRToUSD(@Query() args: ConvertIRRToUSD) {
    return this.facade.convertIRRToUSD(args);
  }
  ...
  async convertUSDToOther(@Query() args: ConvertUSDToFiat) {
    return this.facade.convertUSDToOther(args);
  }
  ...
  async convertCryptoToCrypto(@Query() args: ConvertCryptoTyCrypto) {
    return this.facade.convertCryptoToCrypto(args);
  }
  ...
  async convertEURToCrypto(@Query() args: ConvertEURToCrypto) {
    return this.facade.convertEURToCrypto(args);
  }
}
